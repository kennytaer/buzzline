...
export async function action({ request, context }: ActionFunctionArgs) {
  ...
  const contactListId = formData.get("contactListId")?.toString();
  ...
  try {
    ...
    // If no contact list is selected, create or find a default one
...
export default function NewContact() {
  const { contactLists } = useLoaderData<typeof loader>();
        ...
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-8">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <h1 className="text-3xl font-bold text-[#313131]">Add New Contact</h1>
            </div>
            <p className="text-gray-600">Create a new contact and add them to your lists</p>
          </div>

          {/* Form */}
          <div className="bg-white rounded-xl shadow-sm border border-gray-100">
            <div className="p-6 border-b border-gray-100">
              <h2 className="text-lg font-semibold text-[#313131]">Contact Information</h2>
            </div>
            ...
            <Form method="post" className="p-6 space-y-6">
              ...
              <div>
                ...
                >
                  <option value="">No list (can be assigned later)</option>
                ...
                <p className="mt-1 text-sm text-gray-500">
                  Assign this contact to a specific list, or leave blank to assign later.
                </p>
              </div>
